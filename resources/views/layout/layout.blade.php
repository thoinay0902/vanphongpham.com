...
<head>
    ...
    <link rel="shortcut icon" href="{{ url('public/home/img/logo-fruit-icon.png') }}" />
    <!-- Google Font -->
...
<body style="font-family: 'Mulish', sans-serif;">
    <style>
        .header__top__right__auth #hover-color-a:hover{
            color: green;
        }
...
******************************************************************/
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#" >
                <img src="{{ url('public/home/img/logo.png') }}">
            </a>
        </div>
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li><a href="./shop-grid.html">Sản phẩm chi tiết</a></li>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6  ">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> hello@thoiduong0.com</li>
                                <li>Miễn phí ship khi mua hàng trên 300000vnđ</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 ">
                        <div class="header__top__right">
                            <div class="header__top__right__auth" style="margin-right:5px;">
                                <a href="{{ url('page-login') }}" id="hover-color-a">
                                    <i class="fa fa-sign-in"></i> Đăng nhập
                                </a>
                            </div>
                            <div class="header__top__right__auth" style="margin-left:5px;">
                                <a href="{{ url('page-register') }}" id="hover-color-a">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="{{ url('/') }}"><img src="{{ url('public/home/img/logo.png') }}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            {{--  <li><a href="#"><i class="fa fa-heart"></i> <span>1</span></a></li>  --}}
                            <li><a href="{{ url('shopping-card') }}"><i class="fa fa-shopping-bag"></i> <span>3</span></a></li>
                        </ul>
                        {{--  <div class="header__cart__price">item: <span>$150.00</span></div>  --}}
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Address: Núi Mây - Ấp Tà Săng - Dương Hòa - Kiên Lương - Kiên Giang</li>
                            <li>Phone: +84925434581</li>
                            <li>Email: thoiduong0@gmail.com</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6" >
                    <div class="footer__widget">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62814.27302932833!2d104.53998007910154!3d10.270279999999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a761c1c0d1d41d%3A0xd6a5502c7f78e3d7!2zQ-G6p3UgVMOgIFjEg25n!5e0!3m2!1svi!2s!4v1603443471559!5m2!1svi!2s"
    ...
    <script src="{{('public/home/js/jquery.slicknav.js')}}"></script>
    <script src="{{('public/home/js/mixitup.min.js')}}"></script>
